...
$app = new MyApp\Controller\DetailCategory();
   ...
   <div id="breadcrumb">
    ...
    <div class="container">
        <div class="category_wrapper">
          ...
          <ul>
           <?php foreach($app->getValues()->DetailCategory as $list): ?>
            <li><a <?php if ($_GET['detail_category_name']==$list->detail_category_name){echo "class='active'";} ?> href="http://192.168.33.10:8000/detailCategory.php?category_name=<?php echo h($_GET['category_name']);?>&amp;detail_category_name=<?php echo h($list->detail_category_name);?>"><?= h($list->detail_category_name) ?><span>></span></a></li>
           <?php endforeach; ?>
          </ul>
        </div>
        <div class="column-box-wrapper">
          ...
          <?php foreach($app->getValues()->Detail_Category_menus as $menu): ?>
